...
class TransactionControllerTest {
    ...
    void findBySeason_asMember_returns403() throws Exception {
        when(transactionService.findBySeasonWithFilters(1L, null, null)).thenReturn(List.of());
    ...
    void findByFundingSource_asMember_returns403() throws Exception {
        when(transactionService.findByFundingSourceId(5L)).thenReturn(List.of());
    ...
    void findBySeasonTypeAndBudgetItem_asTeamLeader_returns200() throws Exception {
        when(transactionService.findBySeasonWithFilters(1L, Transaction.TransactionType.ACTUAL, 5L))
                .thenReturn(List.of());
    ...
    void delete_asTreasurer_returns204() throws Exception {
        ...
        verify(transactionService).delete(eq(10L), eq(1L));
    }
