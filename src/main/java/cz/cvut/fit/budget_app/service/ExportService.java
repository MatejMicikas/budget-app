...
public class ExportService {
    ...
    public String exportTransactionsCsv(Long seasonId) {
        List<Transaction> transactions = transactionRepository.findBySeasonId(seasonId);

        StringBuilder sb = new StringBuilder();
        sb.append("id,date,type,direction,amount,budgetItemId,budgetItemName,description\n");
